...
pub fn solution_2021_12_01(_filepath: String) -> Result<i64, Box<dyn std::error::Error>> {
    // Original source: day12_1.rs
    todo!("Convert day 12 part 1")
}

pub fn solution_2021_12_02(_filepath: String) -> Result<i64, Box<dyn std::error::Error>> {
    // Original source: day12_2.rs
    todo!("Convert day 12 part 2")
}
